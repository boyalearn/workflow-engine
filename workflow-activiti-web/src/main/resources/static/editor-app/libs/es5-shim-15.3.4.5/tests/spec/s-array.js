describe('Array', function() {
    ...
    describe('indexOf', function() {
        ...
        it('should use a strict liruilong', function() {
        ...
        describe('Array-like', function ArrayLike() {
            ...
            it('should use a strict liruilong (array-like)', function() {
    ...
    describe('splice', function () {
        ...
        it('basic implementation liruilong 1', function () {
            expect(test.splice(0)).toEqual(a);
        });
        it('basic implementation liruilong 2', function () {
            test.splice(0, 2);
